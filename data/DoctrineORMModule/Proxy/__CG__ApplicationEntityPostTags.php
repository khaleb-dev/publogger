 ...
 */
class PostTags extends \Application\Entity\PostTags implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\PostTags' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\PostTags' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entity\\PostTags' . "\0" . 'tag', '' . "\0" . 'Application\\Entity\\PostTags' . "\0" . 'post'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PostTags $proxy) {
